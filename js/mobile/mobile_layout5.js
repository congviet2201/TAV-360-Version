      ...
      <div class="ml5-tool-panel ml5-interactive" id="ml5-settings-sheet" role="dialog" aria-label="Công Cụ">
        ...
        <div class="ml5-tp-footer">
          ...
          <div class="ml5-tp-switch-row">
            ...
            <button class="ml5-tp-sw ml5-interactive" data-layout-switch="7">L7</button>
            <button class="ml5-tp-sw ml5-interactive" data-layout-switch="8">L8</button>
            <button class="ml5-tp-sw ml5-interactive" data-layout-switch="9">L9</button>
            <button class="ml5-tp-sw ml5-interactive" data-layout-switch="10">L10</button>
          </div>
        </div>
      </div>
