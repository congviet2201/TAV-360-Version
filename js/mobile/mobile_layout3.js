...
(function () {
  ...
  function buildDOM() {
    ...
    const settingsGridHTML = `
      ...
      <button class="ml3-setting-btn ml3-interactive" data-action="contact">
        ${ICONS.contact}
        <span>Tư Vấn</span>
      </button>
    ...
    return `
      ...
      <!-- ⑨ Region Sheet (LIÊN KẾT VÙNG) -->
      <div class="ml3-sheet" id="ml3-region-sheet" role="dialog" aria-label="Bản Đồ Liên Kết Vùng">
        <div class="ml3-sheet-handle" id="ml3-region-handle"></div>
        <div class="ml3-sheet-header">
          <span class="ml3-sheet-title">Bản Đồ Liên Kết Vùng</span>
          <div class="ml3-sheet-close ml3-interactive" id="ml3-region-close">${ICONS.close}</div>
        </div>
        <div class="ml3-region-scroll">
          <div class="ml3-region-map-container">
            <img src="regional_map.png" class="ml3-region-map" alt="Regional Map">
          </div>
        </div>
      </div>
    `;
  ...
  function openSheet(sheetId) {
    ...
    if (backdrop) {
      ...
      if (sheetId === 'ml3-nav-sheet' || sheetId === 'ml3-region-sheet') {
  ...
  function closeAllSheets() {
    ['ml3-nav-sheet', 'ml3-settings-sheet', 'ml3-region-sheet'].forEach(id => {
  ...
  function bindEvents() {
    ...
    document.getElementById('ml3-region-close').addEventListener('click', closeAllSheets);
