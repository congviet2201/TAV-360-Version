    ...
    const settingsGridHTML = `
      ...
      <div class="ml3-switcher-row">
        ...
        <div class="ml3-switcher-pills">
          ...
          <button class="ml3-switcher-pill ml3-interactive" data-layout-switch="7">L7</button>
          <button class="ml3-switcher-pill ml3-interactive" data-layout-switch="8">L8</button>
          <button class="ml3-switcher-pill ml3-interactive" data-layout-switch="9">L9</button>
          <button class="ml3-switcher-pill ml3-interactive" data-layout-switch="10">L10</button>
        </div>
      </div>
    `;
